...
function Footer({ setShowLogin }) {
  ...
  return (
    <footer className="bg-white py-12 px-12 font-[sans-serif]" style={{backgroundColor:'#f9fafb'}}>
          ...
          <ul className="mt-10 space-y-6">
            ...
            <li className="flex items-center">
              ...
              <a href="" className="text-blue-500 text-sm ml-3">
                ...
                <strong>Paris City, Country</strong>
              </a>
            </li>
