...
function SeccussAlert({ msg, setShow }) {
  return (
    <div
      className="bg-green-100 text-green-800 pl-4 pr-10 py-4 rounded relative"
      role="alert"
    >
      <div className="inline-block max-sm:mb-2">
        ...
        <strong className="font-bold text-base">Success!</strong>
      </div>
